...
public class Technicien {
	...
	public boolean peutAccederA(String ressource) {
	    switch(this.role_technicien.toLowerCase()) {
	        case "admin":
	            return true;
	        case "technicien":
	            return !"techniciens".equalsIgnoreCase(ressource);
	        case "user":
	            return !"techniciens".equalsIgnoreCase(ressource) 
	                   && !"clients".equalsIgnoreCase(ressource);
	        default:
	            return false;
	    }
	}
