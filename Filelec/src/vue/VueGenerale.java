...
public class VueGenerale extends JFrame implements ActionListener
{
	...
	public VueGenerale() {
		...
		this.panelMenu.setBackground(new Color(0, 123, 255));
	...
	private void gererVisibiliteBoutons(String role) {
	    // Par défaut, tout est invisible
	    this.btProfil.setVisible(false);
	    this.btClients.setVisible(false);
	    this.btTechniciens.setVisible(false);
	    this.btCommandes.setVisible(false);
	    this.btArticles.setVisible(false);
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    else if (e.getSource() == this.btClients && this.btClients.isVisible()) {
	        this.afficherPanel(1);
	    }
	    else if (e.getSource() == this.btTechniciens && this.btTechniciens.isVisible()) {
